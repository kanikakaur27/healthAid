      ...
      <body>
        <div class="container py-24">
          <div class="flex items-center justify-center h-full">
             {clicked && <div class="bg-white shadow-2xl p-4 rounded-2xl border-2 border-gray-40">
              {/* <div class="flex flex-col"> */}
                ...
                {/* <div id="temp"> */}
                      <h4 class="text-3xl align-middle justify-center px-3">
                        {" "}
                        {/* {console.log(price)} */}
                        {price.Price!=="" ? "Positive":"Negative"}
                      </h4>
                      {/* <p class="text-xs text-gray-500">Feels like +14&deg;C</p> */}
                    </div>}
